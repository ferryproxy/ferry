...
ferryctl control-plane join cluster-1 "--data-plane-tunnel-address=${HOST_IP}:31001" "--data-plane-apiserver-address=${HOST_IP}:32001"
echo "::endgroup::"
...
echo "FERRY_PEER_KUBECONFIG=${FERRY_PEER_KUBECONFIG}"
echo ferryctl control-plane join cluster-2 "--data-plane-tunnel-address=${HOST_IP}:31002" "--data-plane-apiserver-address=${HOST_IP}:32002"
ferryctl control-plane join cluster-2 "--data-plane-tunnel-address=${HOST_IP}:31002" "--data-plane-apiserver-address=${HOST_IP}:32002"
echo "::endgroup::"
