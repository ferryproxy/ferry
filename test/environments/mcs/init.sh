...
echo "::group::Enable mcs"
KUBECONFIG="${KUBECONFIG_DIR}/control-plane.yaml"
echo "KUBECONFIG=${KUBECONFIG}"
kubectl label hubs.traffic.ferryproxy.io -n ferry-system control-plane mcs.traffic.ferryproxy.io/service=enabled
kubectl label hubs.traffic.ferryproxy.io -n ferry-system cluster-1 mcs.traffic.ferryproxy.io/service=enabled
echo "::endgroup::"
